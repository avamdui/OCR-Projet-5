  ...
  <div class="col-md-6">
    <div class="row">
      <div class="col-sm-6 col-md-5">
        ...
        <div class="socials">
            <ul>
              <li><a href=""><i class="bi bi-facebook" style="font-size: 2rem"></i></span></a></li>
              <li><a href=""><i class="bi bi-instagram"style="font-size: 2rem"></i></span></a></li>
              <li><a href=""><i class="bi bi-twitter" style="font-size: 2rem"></i></span></a></li>
              <li><a href=""><i class="bi bi-linkedin" style="font-size: 2rem"></i></span></a></li>
            </ul>
        </div>
      </div>
