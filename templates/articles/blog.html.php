            ...
            <div class="row ">
                    ...
                    <div class="col-8">
                        <div class="card-body">  
                            ...
                            <a class="btn btn-info" href="index.php?controller=ArticleController&task=showOneArticle&id=<?= $article->getId() ?>">Lire cet article</a>
                        </div>
                    </div>
            </div>
        </div>
...
<hr>
                    <ul class="nav justify-content-center rounded  ">
                        ...
                        <li class="page-item <?= ($asvm->currentPage == 1) ? "disabled" : "" ?>">
                            <a href="/index.php?controller=ArticleController&task=showAllArticlesWithPagination&page=<?= $asvm->currentPage - 1 ?>" class="page-link">Précédente</a>
                        </li>
                        ...
                        <?php endfor ?>
                          ...
                          <li class="page-item <?= ($asvm->currentPage == $asvm->totalPage) ? "disabled" : "" ?>">
                            <a href="/index.php?controller=ArticleController&task=showAllArticlesWithPagination&page=<?= $asvm->currentPage + 1 ?>" class="page-link">Suivante</a>
                        </li>
                    </ul>
<br>
